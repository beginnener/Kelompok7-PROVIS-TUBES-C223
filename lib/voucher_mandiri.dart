...
class VoucherMANDIRIScreen extends StatelessWidget {
  const VoucherMANDIRIScreen({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Discount Text
              const Text(
                'DISKON 20% s/d Rp40.000 Bayar dengan Kartu MANDIRI',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 16,
                ),
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          '2. Promo berlaku untuk transaksi dengan Kartu Debit MANDIRI',
                          style: TextStyle(fontSize: 13),
                        ),
                      ],
                    ),
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text(
                          'Spesial untuk Anda, nikmati voucher diskon 20% hingga Rp40.000 dengan menggunakan kartu MANDIRI',
                          style: TextStyle(fontSize: 13),
                        ),
                      ],
                    ),
